...
description = (
    'Data structures, algorithms and educational '
...
if platform.system() != 'Windows':
    if icc:
        ssw_extra_compile_args.extend(
            ['-qopenmp-simd', '-DSIMDE_ENABLE_OPENMP']
        )
    elif not clang:
        ssw_extra_compile_args.extend(
...
extensions = [
    Extension(
        'skbio.metadata._intersection', ['skbio/metadata/_intersection' + ext]
    ),
    Extension(
