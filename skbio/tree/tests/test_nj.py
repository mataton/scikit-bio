...
class NjTests(TestCase):
    def setUp(self):
        ...
        self.expected1_str = (
            '(d:2.000000, (c:4.000000, (b:3.000000,'
    ...
    def test_nj_dm1(self):
        self.assertEqual(
            nj(self.dm1, result_constructor=str), self.expected1_str
        )
    ...
    def test_nj_dm3(self):
        ...
        self.assertAlmostEqual(
            actual_TreeNode.compare_tip_distances(self.expected3_TreeNode), 0.0
        )
    ...
    def test_compute_collapsed_dm(self):
        ...
        self.assertEqual(
            _compute_collapsed_dm(self.dm1, 'a', 'b', True, 'x'), expected1
        )
    ...
    def test_pair_members_to_new_node(self):
        self.assertEqual(
            _pair_members_to_new_node(self.dm1, 'a', 'b', True), (2, 3)
        )
        self.assertEqual(
            _pair_members_to_new_node(self.dm1, 'a', 'c', True), (4, 5)
        )
        self.assertEqual(
            _pair_members_to_new_node(self.dm1, 'd', 'e', True), (2, 1)
        )
