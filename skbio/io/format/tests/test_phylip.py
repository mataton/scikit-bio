...
from skbio.io.format.phylip import (
    _tabular_msa_to_phylip,
    _phylip_to_tabular_msa,
    _phylip_sniffer,
)
...
class TestReaders(unittest.TestCase):
    def setUp(self):
        ...
        self.invalid_files = [
            ...
            for e in [
                ('empty', PhylipFormatError, r'This file is empty.'),
                (
                    'whitespace_only',
                    PhylipFormatError,
    ...
    def setUp(self):
        ...
        variable_length_ids = TabularMSA(
            [
                ...
                DNA('GGGGGG', metadata={'id': 'ab def42ij'}),
            ],
            minter='id',
        )
        ...
        # alignment)
        single_seq_short = TabularMSA(
            [DNA('-', metadata={'id': ''})], minter='id'
        )
