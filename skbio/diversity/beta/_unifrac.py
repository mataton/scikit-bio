...
def _weighted_unifrac(
    ...
    wu = (
        branch_lengths * np.absolute(u_node_proportions - v_node_proportions)
    ).sum()
...
def _setup_multiple_weighted_unifrac(
    counts, otu_ids, tree, normalized, validate
):
