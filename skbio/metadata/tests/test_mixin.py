...
class TestPositionalMetadataMixin(
    ...
    def setUp(self):
        class ExamplePositionalMetadataMixin(PositionalMetadataMixin):
            ...
            def __copy__(self):
                ...
                copy._positional_metadata = PositionalMetadataMixin._copy_(
                    self
                )
                return copy
            ...
            def __deepcopy__(self, memo):
                copy = self.__class__(self._axis_len, positional_metadata=None)
                copy._positional_metadata = PositionalMetadataMixin._deepcopy_(
                    self, memo
                )
                return copy
...
class TestIntervalMetadataMixin(
